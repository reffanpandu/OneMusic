...
<div class="row">
  ...
  <div class="col-md-8">
        ...
        <div class="carousel-item active">
            <img src="img/bg-img/coldiac3.jpg" alt="Los Angeles">
        </div>
        <div class="carousel-item">
            <img src="img/bg-img/coldiac2.jpg" alt="Chicago">
        </div>
        <div class="carousel-item">
            <img src="img/bg-img/coldiac1.jpg" alt="New York">
        </div>
        </div>
  ...
  <div class="col-md-4">
    <h3 class="my-3 text-center">COLDIAC EXCLUSIVE PACKAGE MUSIC ALBUM "O"</h3>
    <h4 class="text-center">Rp.450.000</h4>
    <p>EXCLUSIVE PACKAGE ALBUM KEDUA COLDIAC TELAH RILIS.
    <br>
    Boxset ini berisi collectible items yang membuat kita bisa kenal coldiac lebih jauh.
    <br>
    <br>
    • CD Album.
    <br>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div>
                  <input type="hidden" class="form-control" name="id_produk" value="2">
                </div>
                <div>
                  <input type="hidden" class="form-control" name="produk" value="COLDIAC - O">
                </div>
                <div class="form-group text-center">
                  ...
                  <div>
                  <input type="hidden" class="form-control" name="bayar" value="450000">
                </div>
